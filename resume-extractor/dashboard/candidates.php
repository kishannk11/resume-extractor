                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Candidates List</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted mb-3">Here are the candidates who have applied</p>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <th>Phone Number</th>
                                            <th>No of Experience( Years & Months)</th>
                                            <th>Skills</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>9740684686</td>
                                            <td>5.2</td>
                                            <td>React JS, HTML, CSS, Flutter</td>
                                            <td>                                                       
                                                <a href="#" class="mr-2"><i class="fas fa-download text-info font-16"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Tiger Nixon</td>
